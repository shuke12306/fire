...
- Topic detail now pages replies through shared Rust `fetchTopicScreen` / `fetchTopicResponsePage` calls, with the original post rendered separately and reply rows arriving in Rust-owned tree order rather than host-rebuilt window order.
